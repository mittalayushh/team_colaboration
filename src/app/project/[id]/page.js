          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg w-full max-w-md">
              ...
              <form onSubmit={handleCreateTask}>
                <div className="mb-4">
                  <label className="block text-black mb-2">Task Title</label>
                  <input
                    type="text"
                    value={newTask.title}
                ...
                <div className="mb-4">
                  <label className="block text-black mb-2">Assignee</label>
                  <input
                    type="text"
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 mb-2 text-black">Due Date</label>
                  <input
                    type="date"
